...
import { Copy, Zap, Shield, Phone, CheckCircle, MapPin, ArrowRight } from 'lucide-react';
...
const services = [
  {
    ...
    description: "Expert repair and maintenance for all copier models in Saskatoon",
...
const copierModels = [
  ...
  { brand: "Konica Minolta", models: "bizhub series" },
...
export default function CopierServiceSaskatoonPage() {
  return (
    <>
      <Helmet>
        <title>Copier Service Saskatoon | Repair & Maintenance | Vonex</title>
        <meta name="description" content="Professional copier repair and maintenance service in Saskatoon. Fast response, certified technicians for Kyocera, HP, Lexmark & all major brands. Call (306) 881-0341." />
        <link rel="canonical" href="https://vonex.ca/copier-service-saskatoon" />
      </Helmet>
          ...
          <div className="container-custom">
            <div className="text-center mb-20">
              ...
              <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 mb-8">
                Copier Service in Saskatoon
              </h1>
              <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed mb-8">
                Professional copier repair, maintenance, and support services for Saskatoon businesses. 
                From routine maintenance to emergency repairs, we keep your equipment working efficiently.
              </p>
              <a
            ...
            <div className="bg-white rounded-3xl p-12 shadow-lg mb-20">
              <h2 className="text-4xl font-bold text-gray-900 text-center mb-12">Copier Brands We Service in Saskatoon</h2>
            ...
            <div className="bg-gradient-to-br from-primary-50 to-blue-50 rounded-3xl p-12 mb-20">
              <h2 className="text-4xl font-bold text-gray-900 text-center mb-12">Why Choose Our Saskatoon Service?</h2>
            ...
            <div className="bg-primary-600 rounded-3xl p-12 text-center text-white">
              <h2 className="text-3xl font-bold mb-6">Need Copier Service in Saskatoon?</h2>
              <p className="text-xl text-primary-100 mb-8 max-w-3xl mx-auto leading-relaxed">
                Get reliable copier repair and maintenance service for your Saskatoon business. Contact us for fast, professional support.
              </p>
